...
#
def TPE(detectorF, predictorF, picturepathF, mouth_centroid_xF, mouth_centroid_yF, ROI_mouthF, widthGF, heightGF):
    # detector = dlib.get_frontal_face_detector()
    # predictor = dlib.shape_predictor("shape_predictor_68_face_landmarks.dat")
    global detector
    detector = detectorF
    global predictor
    predictor = predictorF
    global picturepath
    ...
    # parameter range can be adjusted according to the result
    search_spaceH = {
        "Hkernel_size": hyperopt.hp.quniform('Hkernel_size', 5, 25, 1),
        "Hwavelength": hyperopt.hp.quniform('Hwavelength', 5, 25, 1),
        "Hsig": hyperopt.hp.quniform('Hsig', 2, 8, 1),
        "Hgamma": hyperopt.hp.quniform('Hgamma', 0.1, 0.9, 0.1)
    }
    ...
    # print(Gamma,KernelSize,Sig,Wavelength)
