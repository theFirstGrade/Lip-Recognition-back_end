...
def Features(mouth_centroid_x, mouth_centroid_y, b, shotname, Gabor_path, SheetPath, FeaturesPath):
    ...
    if num > 0:
        ...
        #         1: ["Box_width", width],\
        #         2: ["Box_height", height],\
        #         3: ["Final_area", Final_area],\
        #         4: ["Centroid_x", Final_centroidx],\
        #         5: ["Centroid_y", Final_centroidy],\
        #         6: ["intensity", Final_meanintensity * Final_area],\
        #         7: ["orientation", Final_orientation],

        file.save(cur_dir + '/' + str('%02d' % b) + '.xls')
    if num == 0:
        width = 0
        height = 0
        Final_area = 0
